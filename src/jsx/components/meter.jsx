...
import Bootstrap, { Modal, Nav, NavDropdown, MenuItem } from 'react-bootstrap';
...
export default (props) => {
  ...
  let { type, data, label, suffix, unit, active, isLoading } = props
    ...
    <li className={'meter'+active} >
      ...
      <div className="reading">
        <a href="#" onClick={handleClick}>
          {!isLoading ? <span>{data}{suffixes(suffix, unit)}</span> : <span>...</span>}
        </a>
      </div>
    </li>
  )
